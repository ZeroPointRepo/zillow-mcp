...
<p align="center">
  ...
  Four tools: property lookup by address, lookup by zpid, Zestimates, and listing search, for Claude, ChatGPT, OpenClaw, Hermes Agent, and any MCP client.
</p>
...
**Connect once, then just ask.** Add Zillow MCP to Claude, ChatGPT, OpenClaw, Hermes Agent, or any MCP client a single time, and your AI assistant can pull live Zillow property data (full property records, Zestimates, and listings) right in the conversation. No code, no repeated setup.
